...
public class Animal {
	...
	// Any variable or function that doesn't make sense for an object to have should
	// be made static
	...
	// Any time an Animal object is created this function called the constructor is
	// called
	...
	public Animal() {
		...
		// The if statement performs the actions between the { } if the condition is
		// true
	...
	// Method overloading allows you to accept different input with the same method
	// name
	...
	public void setFavoriteChar() {
		...
		// and the values are int, byte, or char unless you have Java 7 which allows
		// Strings
		switch (randomNumber) {
	...
	protected static void guessMyNumber() {
		...
		// Do while loops are used when you want to execute the code in the braces at
		// least once
		do {
	...
	// This method can except Strings that can be stored in the String array args
	// when it is executed
	...
	public static void main(String[] args) {
		...
		// An array is a fixed series of boxes that contain multiple values of the same
		// data type
